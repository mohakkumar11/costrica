...
if (!function_exists('bookingtours_func')) {
	function bookingtours_func() {
		 ob_start();
		 echo '<script type="text/javascript" src="'. OXY_THEME_URI .'assets/js/interface--30.js"></script>';
		 echo '<div id="CLEVERGRIT_WIDGET_01"><p id="CLEVERGRIT_LOADER" style="background: url('. OXY_THEME_URI .'/assets/images/loader.gif) left center no-repeat; padding: 5px 5px 5px 20px">Searching Availability...</p></div>';
...
add_shortcode( 'bookingtours', 'bookingtours_func' );

if (!function_exists('bookingtour_func')) {
	function bookingtourx_func($atts) {
		extract(shortcode_atts(array(
            'item_id' => -1,
            'category_id' => 2
        ), $atts));
...
add_shortcode( 'bookingtour', 'bookingtourx_func' );