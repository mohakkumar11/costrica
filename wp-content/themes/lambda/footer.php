...
?>
        <?php if ($show_page_footer === 'show'): ?>
            ...
            <?php if ($footer_columns > 0 && $show_footer) : ?>
                <footer id="footer" role="contentinfo">
                    ...
                    <?php endif; ?>
                    <!--<section class="twilio_easy_call_section">
                        <div class="twilio_easy_call_division">
            <?php //echo do_shortcode("[wpc2c label='Click To Call' number='+18558605979']"); ?>
        </div>
                    </section>-->
                </footer>
            <?php endif; ?>
        ...
        document.write(unescape("%3Cscript src='" + lsBaseURL + "tracker.js?_k=ee033c1a78e59e6da48112709b2fe82eaa739a12' type='text/javascript'%3E%3C/script%3E"));
        </script>-->
