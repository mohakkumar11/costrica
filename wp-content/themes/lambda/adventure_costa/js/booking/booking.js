	...
	$.fn.bookingForm=function(options){
		return this.each(function(){
			...
			object = {
				...
				sender: 'info@crvacationing.com', // sender for header in e-mail
				ownerEmail:'info@crvacationing.com', // destination e-mail, message will be send on this e-mail
				...
				successMessage: "Thank you for contacting us! We will get in touch with you shortly.", // success message
				// private fields
				form: null,
				fields: [],
