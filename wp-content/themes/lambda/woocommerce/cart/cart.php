				...
				<form action="<?php echo esc_url( WC()->cart->get_cart_url() ); ?>" method="post">
					...
					<div class="row">
							...
							<?php if ( WC()->cart->coupons_enabled() ) { ?>
								<div class="input-group">
									...
									<span class="input-group-btn">
										<input type="submit" class="btn btn-primary apply_btn" name="apply_coupon" value="<?php _e( 'Apply Coupon', 'woocommerce' ); ?>" />
									</span>
								</div>
						...
						<div class="col-md-3 element-bottom-20">
							<button type="submit" class="btn btn-info btn-block update_btn" name="update_cart" value="<?php _e( 'Update Cart', 'woocommerce' ); ?>">
