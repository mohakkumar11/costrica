				...
				<tr valign="top">
					...
					<td>
						...
						if ( ! rgempty( 'is_error', $version_info ) ) {
							...
							$key_field .= "&nbsp;<i class='fa fa-times gf_keystatus_valid'></i> <span class='gf_keystatus_valid_text'>" . esc_html__( 'Valid Key : Your license key has been successfully validated.', 'gravityforms' ) . '</span>';
						}
