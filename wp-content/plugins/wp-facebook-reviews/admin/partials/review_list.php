		...
		if($reviewtotalcount>0){
			foreach ( $reviewsrows as $reviewsrow ) 
			{
				...
				if($reviewsrow->userpiclocal!=""){
					$userpic = '<img style="-webkit-user-select: none" width="75px" src="'.$reviewsrow->userpiclocal.'">';
					$foundlocalimg=true;
				} else {
					$userpic = '<img style="-webkit-user-select: none" width="75px" src="'.$reviewsrow->userpic.'">';
