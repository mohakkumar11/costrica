...
window.EtTabView = vc.shortcode_view.extend({
	...
	initialize:function (params) {
           ...
           //console && console.log('EtTabView: initialize method called.');
        },
	// Render method called after element is added( cloned ), and on first initialisation
	render: function () {
        //console && console.log('EtTabView: render method called.');
        ...
        //console &&  console.log('EtTabView '+this.$tabs);
		return this;
	},
	ready: function (e) {
        //console && console.log('EtTabView: ready method called.');
    ...
    createAddTabButton:function(){
    	var new_tab_button_id = (+new Date() + '-' + Math.floor(Math.random() * 11));
         ...
         //console &&  console.log(' EtTabView : createAddTabButton');
        },
    addTab:function (e) {
    	//console &&  console.log('addTab');
            ...
            var tab_title = window.i18nLocale.tab,
                tabs_count = this.$tabs.find('[data-element_type=et_single]').length,
                tab_id = (+new Date() + '-' + tabs_count + '-' + Math.floor(Math.random() * 11));
            vc.shortcodes.create({shortcode:'et_single', params:{tab_title:tab_title, tab_id:tab_id}, parent_id:this.model.id});
            //console &&  console.log(' EtTabView :  addTab');
            return false;
        },
        stopSorting:function (event, ui) {
            var shortcode;
             //console &&  console.log(' EtTabView :  stopSorting loading');
            this.$tabs.find('ul.tabs_controls li:not(.add_tab_block)').each(function (index) {
              ...
              //console &&  console.log(' EtTabView :  shortcode save');
            shortcode.save();
        },
       changedContent:function (view) {
            ...
            //console &&  console.log(' EtTabView :  changedContent save');
        },
