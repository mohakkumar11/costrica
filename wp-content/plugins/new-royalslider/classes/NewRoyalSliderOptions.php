...
'caption' => array(
				...
				'video' => array(
		            ...
		            array(
		                ...
		                'type' => 'textarea',
		                'data-type' => 'str',
		                'default' => htmlentities('<iframe src="https://www.youtube.com/embed/%id%?rel=0&autoplay=1&showinfo=0" frameborder="0" allow="autoplay; encrypted-media" allowfullscreen></iframe>')
		            ),
		            array(
		                'name' => 'vimeoCode',
		                ...
		                'type' => 'textarea',
		                'data-type' => 'str',
		                'default' => htmlentities('<iframe src="https://player.vimeo.com/video/%id%?byline=0&portrait=0&autoplay=1" frameborder="0" allow="autoplay; encrypted-media" allowfullscreen></iframe>')
		                ,
		                'delimeter' => true
		            ),
